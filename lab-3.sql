...
CREATE TABLE drug (
  ...
  price_in_dollars double(10,2) NOT NULL,
...
(10,'Apoteket Korpen'),(7,'Boots'),
(6,'Dosfarma'),(3,'Eurapon'),
(9,'KomplettApotek'),(5,'La Spezia'),
(4,'Pharmacie'),(8,'Pharmacy'),
(1,'Podorozhnyk'),(2,'Zielona');


INSERT INTO city VALUES 
(1,'Lviv','Ukraine'),(2,'Krakiv','Poland'),
(3,'Berlin','Germany'),(4,'Paris','France'),
(5,'Rome','Italy'),(6,'Barcelona','Spain'),
(7,'London','England'),(8,'Edinburg','Scotland'),
(9,'Oslo','Norway'),(10,'Stockholm','Sweden');


INSERT INTO producer VALUES 
(1,'Farmak','Ukraine'),(2,'Biowet Pylawy','Poland'),
(3,'Dermapharm','Germany'),(4,'Servier','France'),
(5,'Berlin-Chemie','Italy'),(6,'Uriach','Spain'),
(7,'Morningside','England'),(8,'Edinburg-drug','Scotland'),
(9,'Pharmaceutical','Norway'),(10,'ACIHO','Sweden');
...
(1,'Shevchencko',1,1),(2,'Saint Anna',2,2),
(3,'Rathausplatz',3,3),(4,'Via del Corso',4,4),
(5,'Rue de Roule',5,5),(6,'Valenica',6,6),
(7,'Pall Mall',7,7),(8,'Bread St',8,8),
(9,'Grubeggata',9,9),(10,'Hornsgatan',10,10);


INSERT INTO drug VALUES (
1,'Vizyvit','2022-09-15','2025-09-15',1,5.00,1,1),
...
INSERT INTO primary_package VALUES
 (1,'drops',1),(2,'spray',2),
 (3,'pills',3),(4,'pills',4),
 (5,'ointment',5),(6,'drops',6);
 
 
 INSERT INTO category_of_drug VALUES 
 (1,1,'for the eyes',1),(2,1,'for the throat',2),
 (3,1,'for the stomach',3),(4,1,'from a headache',4),
 (5,1,'from injures',5),(6,1,'for the nose',5);
 
 INSERT INTO composition_of_drug VALUES 
 (1,'naphazoline',1),(2,'benzydamine',2),
 (3,'simethicone',3),(4,'indomethacin',4),
 (5,'xylomethazoline',5);
 
 
 INSERT INTO use_of_drug VALUES 
 (1,'for adults',1),(2,'without age restriction',2),
 (3,'for adults',3),(4,'without age restriction',4),
 (5,'for adults',5);
